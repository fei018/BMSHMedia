...
namespace BMSHMedia.DataAccess.Migrations
{
    ...
    [Migration("20240524012519_ModifyBaseFormSubmit")]
    partial class ModifyBaseFormSubmit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BMSHMedia.Model.Form.BaseForm", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Info_BaseForm");
                });

            modelBuilder.Entity("BMSHMedia.Model.Form.BaseFormSubmit", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Info_BaseFormSubmit");
                });

            modelBuilder.Entity("BMSHMedia.Model.Form.BaseFormSubmitData", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Info_BaseFormSubmitData");
                });
            ...
            modelBuilder.Entity("BMSHMedia.Model.SRS.SRSStackInfo", b =>
                {
                    ...
                    b.Property<string>("ApiUrl_PublishKey")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BMSHMedia.Model.Form.BaseFormSubmitData", b =>
                {
                    b.HasOne("BMSHMedia.Model.Form.BaseFormSubmit", "FormSubmit")
                        .WithMany("FormSubmitDataList")
            ...
            modelBuilder.Entity("BMSHMedia.Model.Form.BaseFormSubmit", b =>
                {
                    b.Navigation("FormSubmitDataList");
                });
