    ...
    public partial class InitialDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PlayUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RTMPUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ApiSecret = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ApiUrl_PublishKey = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Info_SRSStack", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CellPhone = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "手机"),
                    HomePhone = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true, comment: "座机"),
                    Address = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true, comment: "地址"),
                    ZipCode = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "邮编"),
                    CreateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreateBy = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    UpdateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdateBy = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
